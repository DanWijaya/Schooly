    ...
    <div className={classes.root}>
      ...
      <div className={classes.content}>
        ...
        <Typography align="justify" paragraph>
          ...
          bisnis kami seperti merger atau akuisisi. Lihat <a href="#pengungkapan">Vendor, mitra & jenis
        ...
        <div className={classes.contentSection}>
          ...
          <Typography variant="h6" className={classes.contentSectionTitle}>
            <b>Bagaimana kami menggunakan informasi Anda tergantung dengan hubungan Anda dengan kami</b>
          </Typography>
          <ExpansionPanel>
            ...
            <ExpansionPanelDetails style={{ display:  "flex", flexDirection: "column" }}>
              ...
              <ul>
                <li style={{ listStyleType: "disc" }}>
                  ...
                  dan komunikasi dengan Anda (termasuk untuk tujuan pemasaran). {" "}
                  <a href="#keterlibatan-dan-pemasaran-klien">Pelajari lebih lanjut
              ...
              <ul>
                ...
                <li style={{ listStyleType: "disc" }}>
                  ...
                  nama klien kami (misalnya Data Siswa) kecuali seperti yang
                ...
                <li style={{ listStyleType: "disc" }}>
                  ...
                  bisnis. <a href="#vendor">Pelajari lebih lanjut tentang bagaimana kami memastikan
                  informasi Anda dilindungi oleh vendor kami</a>.
                </li>
              </ul>
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      ...
                      email, ID siswa, kredensial akun, dan kelas yang Anda
                ...
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      (sebagai siswa atau instruktur) untuk mengirimkan umpan
        ...
        <div className={classes.contentSection} id="pengungkapan">
          <Divider />
          <Typography variant="h6" className={classes.contentSectionTitle}>
            <b>Vendor, mitra & jenis pengungkapan lainnya </b>
          </Typography>
          <Typography align="justify" paragraph>
          ...
          <Typography id="vendor" align="justify" paragraph>
            Vendor
          </Typography>
          <Typography align="justify" paragraph>
        ...
        <div id="keterlibatan-dan-pemasaran-klien" className={classes.contentSection}>
          <Divider />
          <Typography variant="h6" className={classes.contentSectionTitle}>
          ...
          <Typography align="justify" paragraph>
            Tidak adanya perilaku iklan kepada siswa dalam produk dan layanan kami.
            Kami tidak menggunakan atau mengungkapkan informasi (baik informasi
            pribadi atau lainnya) tentang siswa yang kami kumpulkan melalui
            produk dan layanan pendidikan yang kami sediakan atas nama lembaga
            pendidikan untuk penargetan perilaku iklan kepada siswa. Kami hanya akan
          ...
          <Typography align="justify" paragraph>
            ...
            <ol>
              ...
              <li>
                ...
                <a href="mailto:schoolysystem@gmail.com">schoolysystem@gmail.comi</a>
