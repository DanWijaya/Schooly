...
import { Avatar, Badge, Button, Chip, Divider, FormControl, FormControlLabel, FormHelperText,
   Grid, GridList, GridListTile, MenuItem, IconButton, Paper, Radio, RadioGroup, TextField, Typography, Select } from "@material-ui/core";
              ...
              <Grid item xs sm md container direction="column" spacing={2} className={classes.content}>
                <Grid item>
                  ...
                  <GridList className={classes.gridList} cols={4}>
                    {tileData.map((tile) => (
                      <GridListTile cellHeight={tile.height} key={tile.img} cols={tile.cols || 1}>
