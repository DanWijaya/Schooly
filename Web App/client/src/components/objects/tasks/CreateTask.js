              ...
              >
                ...
                <Grid item className={classes.gridItem}>
                  <FormControl fullWidth variant="outlined" color="primary">
                    <label id="class_assigned" className={classes.inputLabel}>
                      Kelas yang dipilih
                    </label>
                    <Select
                      id="class_assigned"
                    ...
                    >
                      {options.map((kelas) => (
                        <MenuItem key={kelas} selected={true} value={kelas}>
                          {kelas.name}
                        </MenuItem>
                      ))}
                    </Select>
                ...
                <Grid item className={classes.gridItem} style={{marginBottom: "30px"}}>
                 <Button
                   type="submit"
                    style={{
