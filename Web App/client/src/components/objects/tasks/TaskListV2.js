...
import { Button, IconButton, Dialog, Divider, ExpansionPanel, ExpansionPanelDetails, ExpansionPanelSummary,
   Fab, Grid, Hidden, ListItem, ListItemText, Menu, MenuItem, TableCell,
...
function createData(_id, tasktitle, subject, class_assigned, deadline) {
  return { _id, tasktitle, subject, class_assigned, deadline };
}
