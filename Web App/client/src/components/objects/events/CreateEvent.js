...
class CreateEvent extends Component {
	...
	onSubmit = (e) => {
		...
		createEvent(eventData).then((res) => {
			this.setState({ success: true, eventId: res.data });
		}).catch((err) => {
			...
			this.handleOpenSnackbar("error", "Kegiatan gagal dibuat");
		});
	};
	...
	render() {
		document.title = "Schooly | Buat Kegiatan";
		...
		return (
			<div className={classes.root}>
				<UploadDialog
					...
					success={success}
					messageUploading="Kegiatan sedang dibuat"
					messageSuccess="Kegiatan telah dibuat"
					redirectLink={`/kegiatan/${eventId}`}
				/>
				<DeleteDialog
				...
				<Paper>
					<div className={classes.content}>
						...
						<Typography color="textSecondary">
							Tambahkan keterangan kegiatan untuk membuat kegiatan.
					</Typography>
					</div>
					<Divider />
