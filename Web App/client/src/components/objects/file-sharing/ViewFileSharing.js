...
import { Avatar, Fab, Grid, IconButton, ListItem, ListItemAvatar, ListItemText, Paper, Typography } from "@material-ui/core";
...
function ViewFileMaterial(props) {
  const classes = useStyles();
  ...
  document.title = !selectedMaterials.name ? " Lihat File Sharing" : ` ${selectedMaterials.name}`
  ...
  return (
    <div className={classes.root}>
      ...
      <Grid container spacing={2} justify="flex-end" alignItems="center">
        ...
        <Grid item>
          <Link to={`/sunting-FileSharing/${materi_id}`}>
