...
class CreateClassV2 extends Component {
  constructor() {
    super();
    this.state = {
      name: "",
              ...
              <Grid container direction="column" spacing={4} className={classes.content}>
                ...
                <Grid item>
                  ...
                  <FormControl id="walikelas" variant="outlined" color="primary" fullWidth error={Boolean(errors.walikelas) && !this.state.walikelas}>
                    ...
                    <FormHelperText>
                      {Boolean(errors.walikelas) && !this.state.walikelas ? errors.walikelas : null}
                    </FormHelperText>
                  </FormControl>
                </Grid>
                <Grid item>
...
) (withStyles(styles)(CreateClassV2));
