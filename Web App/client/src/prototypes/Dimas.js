...
import Image1 from './Gambar/Untitled Export/Untitled Export/fisika-kuantum-ilustrasi.jpg';
import Image2 from './Gambar/Untitled Export/w644.jpg';
import Image3 from './Gambar/Untitled Export/Untitled Export/drawing-the-chemical-theme-on-a-black-background-FGJT3X.jpg';
...
function SimpleDialog(props) {
        ...
        <div>
          ...
          <Paper className={stylesheet.paper}>
            ...
            <List style={{padding:'2%'}}>
              ...
              <ListItem className={{fontSize:12}}>Dinamika (Gaya dan Hukum Newton)</ListItem>
              <ListItem className={{fontSize:12}}>Gelombang Bunyi dan Cahaya</ListItem>
              <ListItem className={{fontSize:12}}>Listrik AC/DC, Kapasitor</ListItem>
            </List>
          </Paper>
        </div>
      )
        ...
        <div>
          ...
          <Paper className={stylesheet.paper}>
            ...
            <List style={{padding:'2%'}}>
              ...
              <ListItem className={{fontSize:12}}>Peluang dan Kejadian</ListItem>
              <ListItem className={{fontSize:12}}>Operasi Matriks</ListItem>
              <ListItem className={{fontSize:12}}>Kalkulus (Turunan dan Integral)</ListItem>
            </List>
          </Paper>
        </div>
      )
        ...
        <div>
          ...
          <Paper className={stylesheet.paper}>
            ...
            <List style={{padding:'2%'}}>
              ...
              <ListItem className={{fontSize:12}}>Mol dan Konsentrasi (Konsep Mol)</ListItem>
              <ListItem className={{fontSize:12}}>Senyawa Hidrokarbon</ListItem>
              <ListItem className={{fontSize:12}}>Kesetimbangan Kimia</ListItem>
            </List>
          </Paper>
        </div>
      )
  ...
  return (
    <Dialog onClose={handleClose} aria-labelledby="simple-dialog-title" open={open}>
      <DialogTitle id="simple-dialog-title">Deskripsi Mata Pelajaran</DialogTitle>
  ...
  const handleClose = (value) => {
    ...
    return (
        <Grid container direction="row" justify="center" alignItems="center" spacing={2} >
            <Grid item xs={6} sm={3} align="center" style={{padding: '100px',margin:'15px',borderRadius:35,backgroundImage: `url(${Image1})`}}>
